...
enum { SchemeNorm, SchemeSel, SchemeRed, SchemeGre, SchemeOra, SchemeBlu, SchemeIRed, SchemeIOra, SchemeIBlu }; /* color schemes */
...
drawbar(Monitor *m)
{
	...
	if (m == selmon) { /* status is only drawn on selected monitor */
		...
		// drw_text(drw, m->ww - tw - 2 * sp, 0, tw, bh, 0, stext, 0); // uncomment this and comment the while loop to disable colors
		while (1) {
